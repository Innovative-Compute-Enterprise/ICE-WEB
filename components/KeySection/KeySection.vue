<template>
  <div class="w-full h-full grid grid-cols-1 md:grid-cols-3 items-start min-h-[500px] md:min-h-[800px]">
    ...
    <div class="h-full w-auto bg-[#0f151d] p-6 mb-28 md:col-start-2 pt-4">
      <div class="sticky top-28 text-white  text-[48px] md:text-[72px] font-normal leading-[80.78px] tracking-tight">Valores Chave</div>
    </div>
