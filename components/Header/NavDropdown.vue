<template>
  <div class="relative">
    ...
    <button @click="toggleDropdown" class="bg-black text-white leading-6 px-5 py-1 rounded-sm text-[17px] xl:text-[20px]" aria-haspopup="true" :aria-expanded="isDropdownOpen.toString()">
      ...
      <svg v-else xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 inline-block pb-1" aria-hidden="true">
    ...
    <div v-if="isDropdownOpen" class="absolute mt-3 rounded-md shadow-md bg-white p-4 text-[17px]" :class="isMobile ? 'bottom-full mb-3 left-0 w-[290px] text-[14px]' : 'left-0 md:w-[250px] lg:w-[255px] xl:w-[278px]'">
      <p class="font-georgia">Continuum Glow is at the forefront of accelerating growth through visionary strategy and technology empowers companys by focusing on four core pillars: luminous ideas, exceptional products, talented teams, and impeccable execution.</p>
