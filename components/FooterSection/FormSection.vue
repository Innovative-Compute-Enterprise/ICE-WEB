<template>
  <div class="px-12 py-16 md:px-24 md:py-24 bg-blue-500 text-black space-y-6">
    ...
    <input class="hidden" name="bot-field">
      ...
      <div class="flex flex-col">
        <input type="text" id="inputcompany" name="company" placeholder="Your Company" required class="text-input p-6 rounded-md">
      </div>
      <div class="flex flex-col">
        <input type="email" id="inputemail" name="email" placeholder="Your Email" minlength="5" required class="text-input p-6 rounded-md">
      </div>
